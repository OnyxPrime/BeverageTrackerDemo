...
namespace BeverageTracker
{
	...
	public class BindablePicker : Picker
	{
		...
		public static readonly BindableProperty SelectedItemProperty =
			BindableProperty.Create(nameof(SelectedItem), typeof(object), typeof(BindablePicker), null, propertyChanged: null);
		...
		private static void OnItemsSourcePropertyChanged(BindableObject bindable, object value, object newValue)
		{
			...
			{
				var x = (BindablePicker)sender;
				var t = x.Items[x.SelectedIndex];
				x.SelectedItem = t;
			};
